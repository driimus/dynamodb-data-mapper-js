...
[![npm](https://img.shields.io/npm/v/oasin.svg?style=flat)](https://www.npmjs.com/package/@driimus/dynamodb-data-mapper-annotations)
[![Apache 2 License](https://img.shields.io/github/license/awslabs/dynamodb-data-mapper-js.svg?style=flat)](http://aws.amazon.com/apache-2-0/)

This library provides annotations to allow easy integration of domain classes
with the `DataMapper` defined in `@driimus/dynamodb-data-mapper`. These annotations
...
import {
  ...
  table,
  versionAttribute,
} from '@driimus/dynamodb-data-mapper-annotations';
...
```ts
import { attribute, hashKey, table } from '@driimus/dynamodb-data-mapper-annotations';
...
`BinarySet` or `NumberValueSet` (from the `@driimus/dynamodb-auto-marshaller`
package).
