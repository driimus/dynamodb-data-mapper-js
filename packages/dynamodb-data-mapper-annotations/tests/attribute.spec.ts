...
import { isSchema, SchemaType } from '@driimus/dynamodb-data-marshaller';
import { attribute } from '../src/attribute';
import { METADATA_TYPE_KEY } from '../src/constants';
...
describe('attribute', () => {
  ...
  describe('TypeScript decorator metadata integration', () => {
    ...
    it('should recognize values with a constructor of Number as a number', () => {
      ...
      expect(target[DynamoDbSchema].property).toEqual({ type: 'Number' });
    });
    ...
    it('should recognize values with a constructor of BinarySet as a set of binary values', () => {
    ...
    it('should recognize values with a constructor that subclasses BinarySet as a set of binary values', () => {
    ...
    it('should recognize values with a constructor of Set as a set of number values', () => {
    ...
    it('should recognize values with a constructor that subclasses Set as a set of number values', () => {
    ...
    it('should treat arrays with members as tuple types', () => {
      ...
      const members: SchemaType[] = [{ type: 'Boolean' }, { type: 'String' }];
