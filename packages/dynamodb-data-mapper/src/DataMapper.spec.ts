...
import { BatchGetOptions, GlobalSecondaryIndexOptions, ParallelScanState } from '.';
...
describe('DataMapper', () => {
  ...
  describe('#delete', () => {
    const promiseFunc = jest.fn(async () => Promise.resolve({ Attributes: {} }));
    const mockDynamoDbClient = mockClient(DynamoDBClient);
  ...
  describe('#deleteTable', () => {
    ...
    const describeTablePromiseFunc = jest.fn(async () => Promise.resolve({}));
  ...
  describe('#ensureGlobalSecondaryIndexExists', () => {
    ...
    mapper.createGlobalSecondaryIndex = jest.fn(async () => Promise.resolve());
  ...
  describe('#get', () => {
    const promiseFunc = jest.fn(async () => Promise.resolve({ Item: {} } as GetItemOutput));
    const mockDynamoDbClient = mockClient(DynamoDBClient);
  ...
  describe('#put', () => {
    const promiseFunc = jest.fn(async () => Promise.resolve({ Item: {} } as PutItemOutput));
    const mockDynamoDbClient = mockClient(DynamoDBClient);
