...
```javascript
import { marshallItem } from 'ddb-data-marshaller';
...
Will be marshalled and unmarshalled using the `ddb-auto-marshaller`
...
const anyProperty = {
  ...
  // ddb-auto-marshaller package's Marshaller class:
  unwrapNumbers: false,
  onInvalid: 'omit',
  onEmpty: 'nullify',
};
...
unmarshalled using the `ddb-auto-marshaller`.
