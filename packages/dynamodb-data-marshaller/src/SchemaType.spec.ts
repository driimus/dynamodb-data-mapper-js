...
describe('isSchemaType', () => {
	...
	describe('Set types', () => {
		it('should accept StringSet types', () => {
			expect(isSchemaType({type: 'Set', memberType: 'String'})).toBe(
				true,
			);
		});

		it('should accept NumberSet types', () => {
			expect(isSchemaType({type: 'Set', memberType: 'Number'})).toBe(
				true,
			);
		});

		it('should accept BinarySet types', () => {
			expect(isSchemaType({type: 'Set', memberType: 'Binary'})).toBe(
				true,
			);
		});
	});
