import type { BinaryValue, MarshallingOptions } from '@aws/dynamodb-auto-marshaller';
 ...
 */
export interface CollectionType extends BaseType<unknown[]>, MarshallingOptions {
  type: 'Collection';
}
 ...
 */
export interface HashType extends BaseType<Record<string, any>>, MarshallingOptions {
  type: 'Hash';
}
...
export function isSchemaType(arg: any, alreadyVisited: Set<any> = new Set()): arg is SchemaType {
  if (isBaseType(arg)) {
