...
describe('unmarshallItem', () => {
	...
	it('should throw if the schema type tag is not recognized', () => {
		...
		expect(() =>
			unmarshallItem(schema, {binary: {S: 'a string'}}),
		).toThrow();
	});
	...
	describe('binary fields', () => {
		...
		it('should unmarshall binary fields', () => {
			expect(
				unmarshallItem(schema, {binary: {B: new Uint8Array(15)}}),
			).toEqual({binary: new Uint8Array(15)});
		});
	...
	describe('boolean fields', () => {
		...
		it('should unmarshall boolean fields', () => {
			expect(
				unmarshallItem(schema, {boolean: {BOOL: false}}),
	...
	describe('number set fields', () => {
		...
		it('should unmarshall number set fields', () => {
			expect(
				unmarshallItem(schema, {numSet: {NS: ['1', '2', '3']}}),
		...
		it('should unmarshall unexpected types as undefined', () => {
			expect(
				unmarshallItem(schema, {numSet: {SS: ['1', '2', '3']}}),
			).toEqual({});
		});
	});
	...
	describe('set fields', () => {
		...
		it('should throw an error if the memberType is not recognized', () => {
			expect(() =>
				unmarshallItem(schema, {fooSet: {NS: ['1', '2', '3']}}),
	...
	describe('string fields', () => {
		...
		it('should unmarshall string fields', () => {
			expect(unmarshallItem(schema, {string: {S: 'string'}})).toEqual(
				{string: 'string'},
			);
		});
	...
	describe('string set fields', () => {
		...
		it('should unmarshall string set fields', () => {
			expect(
				unmarshallItem(schema, {strSet: {SS: ['a', 'b', 'c']}}),
		...
		it('should unmarshall unexpected types as undefined', () => {
			expect(
				unmarshallItem(schema, {strSet: {NS: ['a', 'b', 'c']}}),
			).toEqual({});
		});
	});
	...
	describe('tuple fields', () => {
		...
		it('should unmarshall unexpected types as undefined', () => {
			expect(
				unmarshallItem(schema, {jobResult: {BOOL: true}}),
			).toEqual({});
		});
	});
});
