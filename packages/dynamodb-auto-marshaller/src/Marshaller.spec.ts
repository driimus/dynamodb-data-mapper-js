...
describe('Marshaller', () => {
    ...
    describe('#marshallValue', () => {
        ...
        describe('maps', () => {
            ...
            it('should omit keys whose values are serialized as undefined', () => {
                const marshaller = new Marshaller();
                expect(marshaller.marshallValue({ a: void 0 })).toEqual({
                    M: {},
                });

                expect(
                    marshaller.marshallValue(new Map([['a', void 0]]))
                ).toEqual({ M: {} });
            });
        ...
        describe('undefined values', () => {
            it('should return undefined for undefined', () => {
                expect(new Marshaller().marshallValue(void 0)).toBeUndefined();
            });
        });
    ...
    describe('#unmarshallItem', () => {
        it('should convert DynamoDB items to plain vanilla JS objects', function () {
            var unmarshalled = new Marshaller({
                unwrapNumbers: true,
            }).unmarshallItem({
                string: { S: 'foo' },
                list: { L: [{ S: 'fizz' }, { S: 'buzz' }, { S: 'pop' }] },
    ...
    describe('#unmarshallValue', () => {
        ...
        describe('number sets', () => {
            it('should convert NumberSetAttributeValues into sets with BigInts', function () {
