...
describe('BinarySet', () => {
  it('should create a set with values provided to the constructor', () => {
    const set = new BinarySet([new Uint8Array([0xde, 0xad]), new Uint8Array([0xbe, 0xef])]);
  ...
  describe('#delete', () => {
    it('should return `true` and remove the provided value if it was found in the set', () => {
      const set = new BinarySet([new Uint8Array([0xde, 0xad]), new Uint8Array([0xbe, 0xef])]);
    ...
    it('should remove values with the same underlying binary value even if the object is a different view type', () => {
      const set = new BinarySet([new Uint8Array([0xde, 0xad]), new Uint8Array([0xbe, 0xef])]);
      expect(set.delete(new Int16Array(new Uint8Array([0xde, 0xad]).buffer))).toBe(true);
      expect(set.size).toBe(1);
    });

    it('should return false and be a no-op if the value is not in the set', () => {
      const set = new BinarySet([new Uint8Array([0xde, 0xad]), new Uint8Array([0xbe, 0xef])]);
  ...
  describe('#entries', () => {
    it('should provide a [key, value] iterable where the key and value are the same (in line with ES6 Set behavior)', () => {
      const set = new BinarySet([new Uint8Array([0xde, 0xad]), new Uint8Array([0xbe, 0xef])]);
  ...
  describe('#keys', () => {
    it('should iterate over all values in the set (in line with ES6 Set behavior)', () => {
      const set = new BinarySet([new Uint8Array([0xde, 0xad]), new Uint8Array([0xbe, 0xef])]);
  ...
  describe('#[Symbol.toStringTag]', () => {
    ...
    it('should cause toString to return a Set-identifying string', () => {
      expect(Object.prototype.toString.call(new BinarySet())).toBe('[object Set]');
    });
  });
});
