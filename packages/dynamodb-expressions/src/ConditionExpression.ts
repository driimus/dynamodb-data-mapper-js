 ...
 * predicate.
 */
export function equals(operand: ComparisonOperand): EqualityExpressionPredicate {
  return {
    type: 'Equals',
    object: operand,
  };
...
export function notEquals(operand: ComparisonOperand): InequalityExpressionPredicate {
  return {
    type: 'NotEquals',
    object: operand,
  };
...
export function lessThan(operand: ComparisonOperand): LessThanExpressionPredicate {
  return {
    type: 'LessThan',
    object: operand,
  };
...
export function greaterThan(operand: ComparisonOperand): GreaterThanExpressionPredicate {
  return {
    type: 'GreaterThan',
    object: operand,
  };
...
export function inList(...operands: ComparisonOperand[]): MembershipExpressionPredicate {
  return {
    type: 'Membership',
    values: operands,
  };
 ...
 * record.
 */
export interface AttributeExistsPredicate extends BaseFunctionExpressionPredicate {
 ...
 * given record.
 */
export interface AttributeNotExistsPredicate extends BaseFunctionExpressionPredicate {
 ...
 */
export interface AttributeTypePredicate extends BaseFunctionExpressionPredicate {
  name: 'attribute_type';
 ...
 */
export interface BeginsWithPredicate extends BaseFunctionExpressionPredicate {
  name: 'begins_with';
  expected: string;
}
 ...
 */
export interface ContainsPredicate extends BaseFunctionExpressionPredicate {
  name: 'contains';
  expected: string;
}
 ...
 */
export function isConditionExpressionPredicate(arg: any): arg is ConditionExpressionPredicate {
...
export function isConditionExpressionSubject(arg: any): arg is ConditionExpressionSubject {
  return (
    Boolean(arg) &&
    typeof arg === 'object' &&
...
export type SimpleConditionExpression = ConditionExpressionSubject & ConditionExpressionPredicate;
...
function serializeFunctionConditionExpression(
  condition:
    | (ConditionExpressionSubject & AttributeExistsPredicate)
    | (ConditionExpressionSubject & AttributeNotExistsPredicate)
    | (ConditionExpressionSubject & AttributeTypePredicate)
    | (ConditionExpressionSubject & BeginsWithPredicate)
    | (ConditionExpressionSubject & ContainsPredicate),
...
function serializeOperand(operand: ComparisonOperand, attributes: ExpressionAttributes): string {
