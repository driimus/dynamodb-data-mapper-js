...
describe('AttributePath', () => {
	...
	it('should allow attribute names with embedded control characters', () => {
		expect(
			new AttributePath(
				'_bracket_\\[_period_\\._backslash_\\\\_unescaped_backslash_\\_.foo',
			).elements,
		).toEqual([
			{
				type: 'AttributeName',
